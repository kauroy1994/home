...
2. Pallagani, V., Roy, Kaushik, et al. (2024). "On the Prospects of Incorporating Large Language Models (LLMs) in Automated Planning and Scheduling (APS)." International Conference on Automated Planning and Scheduling (ICAPS).

3. Shyalika, C., Roy, Kaushik, et al. (2024). "RI2AP: Robust and Interpretable 2D Anomaly Prediction in Assembly Pipelines." Sensors 24, no. 10: 3244.

4. Roy, Kaushik, Khandelwal, V., Vera, V., and Sheth, A. (2024). "GEAR-Up: Generative AI and External Knowledge-based Retrieval Upgrading Scholarly Article Searches for Systematic Reviews." AAAI Conference on Artificial Intelligence 38.

5. Sheth, A., and Roy, Kaushik. (2024). "Neurosymbolic Value-Inspired Artificial Intelligence (Why, What, and How)." IEEE Intelligent Systems 39.1.

6. Sheth, A., Roy, Kaushik, and Gaur, M. (2023). "Neurosymbolic Artificial Intelligence (Why, What, and How)." IEEE Intelligent Systems 38.3.

7. Venkataramanan, R., Roy, Kaushik, et al. (2023). "Cook-Gen: Robust Generative Modeling of Cooking Actions from Recipes." IEEE Conference on Systems, Man, and Cybernetics.

8. Roy, Kaushik, Garg, T., Palit, V., Zi, Y., Narayanan, V., and Sheth, A. (2023). "Knowledge Graph Guided Semantic Evaluation of Language Models For User Trust." IEEE Conference on Artificial Intelligence.

9. Roy, Kaushik, Khandelwal, V., Goswami, R., Dolbir, N., Malekar, J., and Sheth, A. (2023). "Demo Alleviate: Demonstrating Artificial Intelligence Enabled Virtual Assistance for Telehealth: The Mental Health Case." AAAI Conference on Artificial Intelligence.

10. Roy, Kaushik, Gaur, M., Soltani, M., Rawte, V., Kalyan, A., and Sheth, A. (2023). "Proknow: Process Knowledge for Safety Constrained and Explainable Question Generation for Mental Health Diagnostic Assistance." Frontiers in Big Data, Vol. 5.

11. Sheth, A., Gaur, M., Roy, Kaushik, Venkataraman, R., and Khandelwal, V. (2022). "Process Knowledge-Infused AI: Toward User-Level Explainability, Interpretability, and Safety." IEEE Internet Computing 26, no. 5.

12. Chaudhuri, S.K., Kleppinger, J.W., Nag, R., Roy, Kaushik, et al. (2021). "A CdZnTeSe Gamma Spectrometer Trained by Deep Convolutional Neural Network for radioisotope identification." In Hard X-Ray, Gamma-Ray, and Neutron Detector Physics XXIII, Vol. 11838.

13. Sheth, A., Gaur, M., Roy, Kaushik, and Faldu, K. (2021). "Knowledge-intensive Language Understanding for Explainable AI." IEEE Internet Computing 25, no. 5.

14. Roy, Kaushik, Gaur, M., Sharma, A., Srivastava, B., and Sheth, A. (2021). ""Who can help me?": Knowledge Infused Matching of Support Seekers and Support Providers during COVID-19 on Reddit." IEEE International Conference on Healthcare Informatics.

15. Roy, Kaushik, Zhang, Q., Gaur, M., and Sheth, A. (2021). "Knowledge Infused Policy Gradients with Upper Confidence Bound for Relational Bandits." European Conference on Machine Learning.

16. Das, S., Natarajan, S., Roy, Kaushik, Parr, R., and Kersting, K. (2020). "Fitted Q-learning for Relational Domains." Knowledge Representation and Reasoning.

17. Bhat, A., and Roy, Kaushik. (2016). "Optimized KNN for Sequential Execution." International Conference on Inventive Computation Technologies.

18. Nasreen, A., Roy, Kaushik, Roy, K., and Shobha, G. (2015). "Key Frame Extraction and Foreground Modelling using K-means Clustering." International Conference on Computational Intelligence, Communication Systems and Networks.

19. Bhat, A.G., Roy, Kaushik, Anchalia, P.P., and Jeevith, H.M. (2015). "Design and Implementation of a Dynamic Intelligent Traffic Control System." UKSim-AMSS International Conference on Modelling and Simulation.

20. Anchalia, P.P., Roy, Kaushik, and Roy, K. (2015). "Two Class Fisher's Linear Discriminant Analysis Using MapReduce." UKSim-AMSS International Conference on Modelling and Simulation.
